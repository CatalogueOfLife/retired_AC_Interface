...
<html>
<head>
<title>Catalogue of Life : 2006 Annual Checklist : Source databases</title>
...
<form name="show_database" method="get" action="show_database_details.php">
...
?>
                          <p style="margin-bottom:20px">The data in the 2006 Annual 
                            Checklist have been provided by the databases listed 
                            below. Most datasets include one or more global species 
                            database sectors (GSDs), i.e. datasets being developed 
                            to cover all of the world's species in a particular 
                            group of organisms. A few datasets provide regional 
                            information for groups not yet covered globally. The 
                            datasets result from collaboration and editing by 
                            many expert taxonomists, whose names are found in 
                            the datasets themselves. For each database, a brief 
                            summary is listed in the following pages and inside 
                            the database: database short and full names; home 
                            page on the web; the author(s) or editor(s); organisation; 
                            the group for which data are provided, all preceded 
                            by its higher classification; and the number of species 
                            and infraspecific taxa included in this Annual Checklist.</p>
<?php
...
<form name="sort_by_column" method="get" action="info_source_dbs.php">
