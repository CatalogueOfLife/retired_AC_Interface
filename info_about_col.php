...
<html>
<head>
<title>Catalogue of Life : 2008 Annual Checklist : About the Catalogue of Life</title>
...
the year 2011. Rapid progress has been made recently and this, the eighth 
...
known species. This means that for many groups it continues to be deficient, and users will notice that many species are still missing from the Catalogue.</p>
<p>The 
present Catalogue is compiled with sectors provided by 52 taxonomic databases 
...
of Life: 2008 Annual Checklist</b><br> The Annual Checklist is published 
...
at <a href="http://www.catalogueoflife.org/annual-checklist/2008/" target="_blank">http://www.catalogueoflife.org/annual-checklist/2008/</a>. 
Archived earlier editions are also available on the website. This is the preferred edition for public usage during 2008-2009.</p><p>&#149; 
...
available both for users and as an electronic web-service at <a href="http://www.catalogueoflife.org/dynamic-checklist/search.php" target="_blank">http://www.catalogueoflife.org/dynamic-checklist/search.php</a> 
...
of biota of interest to North America. It contains more than 570,000 scientific and common names in all kingdoms, and is accessible via the World Wide Web in English, French, Spanish, and Portuguese (<a href="http://itis.gbif.net" target="_blank" title="ITIS">http://itis.gbif.net</a>). 
...
and an associate member of GBIF.<br> ITIS is managed by Thomas Orrell (Acting  Director), Michael Ruggiero (Senior Scientific Advisor), David Nicolson (Data Development Leader), Mike Frame (Information Technology Leader), Roy McDiarmid (Taxonomy Leader), Guy Baillargeon (ITIS-Canada Director), and Patricia Koleff (SIIT-Mexico Director). They are advised and supported by the ITIS Steering Committee and ITIS Data Stewards.
</p><p>&nbsp;<b>About Species 2000</b>
...
by guarantee (registered in England No. 3479405) with seven directors and 
...
Species 2000 europa (<a href="http://www.sp2000europa.org" target="_blank">http://www.sp2000europa.org</a>), working with global and regional databases 
based in Europe and Species 2000 Asia-Oceania (<a href="http://www.sp2000asiaoceania.org" target="_blank">http://www.sp2000asiaoceania.org</a>) 
...
programme is led by its Team: Guy Baillargeon (Canada), Frank A Bisby (UK), Thierry Bourgoin (France),
Marc Brugman (Netherlands), Jerry Cooper (New Zealand), Dennis Gordon (New 
Zealand), Keping Ma (China), Luciane Marinoni (Brazil), Michael A Ruggiero (USA), Nicolas Bailly (Philippines), Junko Shimura (Japan), Edward Vanden Berghe (Belgium), Richard 
