...
<html>
<head>
<title>Catalogue of Life : 2007 Annual Checklist : Search by scientific name</title>
...
<?php
	...
	if ($search_type != "search_scientific") {
		$kingdom = "" ;
		$phylum = "" ;
		$tax_class = "" ;
		$order = "" ;
...
<script language="JavaScript" type="text/javascript">
	function setFocus() {
<?php
	echo "document.search_form." . $select_taxon . ".focus() ;\n" ;
	if ($show_taxon != "") {
...
<body onload="JavaScript: moveMenu(); setFocus(); preloadImages(); ">
<?php
...
<form name="search_form" method="get" action="search_results.php" onsubmit="JavaScript:showWaitScreen('Search in progress. ');">
	<input type="hidden" name="search_type" value="search_scientific">
                ...
                <tr> 
                  <td> 
                    <table width="100%" border="0" cellspacing="0" cellpadding="10">
                      <tr> 
                        <td>
                          <p class="formheader" align="center">Search for scientific 
                            names</p>
...
<form name="show_names" method="get" action="search_scientific.php">
	<input type="hidden" name="search_type" value="search_scientific">
...
<form name="reset_form" method="get" action="search_scientific.php">
	<input type="hidden" name="genus" value="">
	<input type="hidden" name="species" value="">
	<input type="hidden" name="infraspecies" value="">
</form>
